...
void profileState(string type, int count)
{
  g_system_ptr->getProfiler()->profileState(type, count);
}

void profileLease(string type, int count)
{
  g_system_ptr->getProfiler()->profileLease(type, count);
}

void profileRequestMiss(string type)
{
  g_system_ptr->getProfiler()->profileRequestMiss(type);
}

void profilePtsChange(string type, Time pts_change)  
{
  g_system_ptr->getProfiler()->profilePtsChange(type, pts_change);
}

void profileNumExpiredBlocks(string type, int count) 
{
  g_system_ptr->getProfiler()->profileNumExpiredBlocks(type, count);
}
...
void profileExpiredBandwidth(string type, MessageSizeType size)
{
  g_system_ptr->getProfiler()->profileExpiredBandwidth(type, size);
}
...
void profileNumberOfLoads(int num_loads) {
    g_system_ptr->getProfiler()->profileNumberOfLoads(num_loads);
}
