...
void TraceRecord::issueRequest() const
{
  ...
  CacheMsg request(m_data_address, m_data_address, m_type, m_pc_address, AccessModeType_UserMode, 0, PrefetchBit_Yes, 0, Address(0), 0 /* only 1 SMT thread */, 0, 0, 0, 0, false,MemorySpaceType_NULL,false,0,0);
