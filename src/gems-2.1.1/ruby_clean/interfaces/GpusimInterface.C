...
void  GpusimInterface::makeRequest( unsigned long long addr, unsigned req_size, unsigned sid, unsigned tid, 
		                    unsigned dynamic_cta_id, unsigned dynamic_warp_id, unsigned dynamic_request_id, 
				    unsigned pc, CacheRequestType req_type, bool isPriv, MemorySpaceType space,
...
void  GpusimInterface::makeMemfenceRequest( unsigned long long addr, unsigned req_size, unsigned sid, unsigned tid, 
		                            unsigned dynamic_cta_id, unsigned dynamic_warp_id, unsigned dynamic_request_id, 
		                            unsigned pc, CacheRequestType req_type, bool isPriv, MemorySpaceType space,
...
//**************************************************************************
int  GpusimInterface::isReady( unsigned long long addr, unsigned req_size, unsigned sid, unsigned tid, 
		               unsigned dynamic_cta_id, unsigned dynamic_warp_id, unsigned dynamic_request_id,
			       CacheRequestType req_type, MemorySpaceType space)
{
  unsigned cpuNumber = sid;
  unsigned long long physicalAddr = addr;
  unsigned long long logicalAddr = addr;
