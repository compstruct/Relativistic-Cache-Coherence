...
private:
  ...
  * TardisDec Predictor
  */
class TCpredictorTardisDec : public TCpredictorBase {
public:
    TCpredictorTardisDec();
    ~TCpredictorTardisDec();
    ...
    Time get_pred_lifetime();
    Time update_lifetime_load(Time pred_lease);
    Time update_lifetime_writeatomic(Time pred_lease);
...
private:
  ...
  * TardisInc Predictor
  */
class TCpredictorTardisInc : public TCpredictorBase {
public:
    TCpredictorTardisInc();
    ~TCpredictorTardisInc();
...
/*
 * TardisPCAdaptive Predictor
 */
class TCpredictorTardisPCAdaptive : public TCpredictorBase {
public:
    TCpredictorTardisPCAdaptive();
    ~TCpredictorTardisPCAdaptive();
    ...
    Time get_pred_lifetime(int pc);
    void update_lifetime_load(int pc);
    void update_lifetime_writeatomic(int pc);

private:
    int m_pred_min;
    int m_pred_max;
    int m_pred_shift;
    std::map<int, int> m_leases;
};
