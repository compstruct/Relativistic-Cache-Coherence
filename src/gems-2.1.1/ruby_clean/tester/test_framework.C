...
void sendruby_request( unsigned long long addr, unsigned req_size, unsigned sid, unsigned tid, 
		       unsigned dynamic_cta_id, bool dynamic_warp_id, unsigned dynamic_request_id, 
