...
private:
  ...
  Map<string,unsigned long>* m_profiling_state;
  Map<string,unsigned long>* m_profiling_lease;
  Map<string,unsigned long>* m_profiling_request_miss;
  Map<string, Histogram>* m_profiling_pts_changes;
  Map<string, Histogram>* m_profiling_num_expired_blocks;
  Map<string,unsigned long>* m_profiling_bandwidth;
  Map<string,unsigned long>* m_profiling_expired_bandwidth;
  Map<string,unsigned long>* m_profiling_bandwidth_alt;
  Histogram m_profiling_number_loads;
